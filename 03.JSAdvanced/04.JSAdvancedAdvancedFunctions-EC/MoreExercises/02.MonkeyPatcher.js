...
main.call(post, 'upvote');
main.call(post, 'downvote');
console.log(main.call(post, 'score')); // [127, 127, 0, 'controversial']

for (let i = 0; i < 50; i++) {
    main.call(post, 'downvote');
}

console.log(main.call(post, 'score')); // [139, 189, -50, 'unpopular']